...
### Доработка, обращение к контейнеру multitool 
```
frozzy@GalyshevDV:~$ kubectl get po -o wide
NAME                     READY   STATUS    RESTARTS   AGE     IP           NODE             NOMINATED NODE   READINESS GATES
multitool                1/1     Running   0          5m14s   10.1.0.204   docker-desktop   <none>           <none>
myapp-6ff8dd96cf-86ljz   2/2     Running   0          6m30s   10.1.0.203   docker-desktop   <none>           <none>
myapp-6ff8dd96cf-cs7pk   2/2     Running   0          6m30s   10.1.0.202   docker-desktop   <none>           <none>
frozzy@GalyshevDV:~$ kubectl exec -it multitool -c multitool -- curl 10.1.0.203:1180
WBITT Network MultiTool (with NGINX) - myapp-6ff8dd96cf-86ljz - 10.1.0.203 - HTTP: 1180 , HTTPS: 11443 . (Formerly praqma/network-multitool)
frozzy@GalyshevDV:~$ kubectl exec -it multitool -c multitool -- curl 10.1.0.204:1180
WBITT Network MultiTool (with NGINX) - multitool - 10.1.0.204 - HTTP: 1180 , HTTPS: 11443 . (Formerly praqma/network-multitool)
```
