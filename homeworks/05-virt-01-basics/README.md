...
### Ответ
1. Чувствительная база данных (Физический сервер) - На железном сервере всё-таки проще настроить бэкапы и минимизировать возникновение ошибок.
2. Web-приложения (виртуализация уровня ОС) - Для этих целей идеально подходит docker.
3. Windows для бухгалтеров (паравиртуализация) - Необходимо выполнять несколько windows систем одновременно.
4. GPU (физический сервер) - Предполагаю что должна прямая связь с железом для более быстрой работы.
